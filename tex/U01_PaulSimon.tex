...
% Define bash language safely (no $ errors)
\lstset{
  language=bash,
  basicstyle=\ttfamily
}
...
\begin{document}
    ...
    \end{verbatim}
    Der Einsatz mehrerer Threads bringt nur eine kleine Beschleunigung (ca. 14 \% gegenüber einem Thread),danach keine nennenswerte Verbesserung.
    Ein Grund könnte sein, dass die Aufgabe stark I/O-gebunden ist.
\end{document}